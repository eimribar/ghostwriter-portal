-- =====================================================
-- CORRECT YOUTUBE IDEATION SETUP - FINAL VERSION
...
-- Step 2: Create the main RevOps YouTube transcript prompt
...
-- Step 3: Create a simple fallback YouTube prompt
INSERT INTO prompt_templates (
  name,
  category,
  description,
...
-- Step 5: Create helper function to get YouTube prompts
...
-- Step 6: Test function to verify setup
...
BEGIN
  ...
  RAISE NOTICE '3. Deploy updated code to Vercel';
